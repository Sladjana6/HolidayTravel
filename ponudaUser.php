...
<?php
      ...
      <li><a href='ponudaUser.php?logof=izlogujSe'>ODJAVI SE</a></li>
</div>
...
<div id="tour" class="bg-1">
  <div class="container">
    ...
    <select name="cena" id="cena" onchange="ponudaAjax()">
            <option value="">Cena</option>
            <option value="ASC">Rastući redosled</option>
            <option value="DESC">Opadajući redosled</option>
</select>

<div id="ponuda" name="ponuda">
    <?php include "ucitajPonuduUser.php"; ?>
</div>
