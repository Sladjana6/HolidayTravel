  ...
  <div  class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-left">
        ...
        <li><a href="ponudaUser.php">PONUDA</a></li>
        <li><a href="rezervacijaUser.php">REZERVACIJE</a></li>
    ...
    <?php
      ...
      <li><a href='rezervacijaUser.php?logof=izlogujSe'>ODJAVI SE</a></li>
</div>
...
<div id="tour" class="bg-1">
  <div class="container">
    <h3 class="text-center">Vaše rezervacije</h3>
      

<div id="rezervacija" name="rezervacija">
    <?php include "ucitajRezervacijaUser.php"; ?>
</div>
